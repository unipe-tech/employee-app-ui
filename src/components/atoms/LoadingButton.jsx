  ...
  render() {
    return (
      <View style={styles.container}>
        <TouchableWithoutFeedback accessibilityLabel={this.props.accessibilityLabel} disabled={this.props.disabled} onPress={!this.state.showLoading ? this.props.onPress : null}>
          <Animated.View
            style={[
              styles.containerButton,
              {
                ...
                backgroundColor: this.props.disabled ? COLORS.lightGray : COLORS.primary,
