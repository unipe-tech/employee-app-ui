package com.employeeapp.rnbackgroundfetch;
...
public class HeadlessTask implements HeadlessJsTaskEventListener {
     ...
     *
     * @param taskConfig describes what task to start and the parameters to pass to
     *                   it
     */
        ...
        if (reactContext == null) {
            reactInstanceManager.addReactInstanceEventListener(new ReactInstanceManager.ReactInstanceEventListener() {
                ...
                public void onReactContextInitialized(final ReactContext reactContext) {
                    // Hack to fix unknown problem executing asynchronous BackgroundTask when
                    // ReactContext is created *first time*. Fixed by adding short delay before
                    // #invokeStartTask
